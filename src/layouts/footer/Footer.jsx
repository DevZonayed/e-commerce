              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="footer-widget footer1-widget footer1-widget2 mb-40">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">Baby Corner</a>
                    </li>
                    <li>
                      <a href="#">Man & Woman Shoe</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="footer-widget footer1-widget footer1-widget3 mb-40 ">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">Order Tranking</a>
                    </li>
                    <li>
                      <a href="#">List of Shops</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="cards-wrapper cards-wrapper-lines">
                ...
                <div className="card-links">
                  <ul>
                    <li>
                      <a href="#">
                        <img src="assets/img/cards/card-1.png" alt="card-img" />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="assets/img/cards/card-2.png" alt="card-img" />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="assets/img/cards/card-3.png" alt="card-img" />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="assets/img/cards/card-4.png" alt="card-img" />
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="app-links">
                  <ul>
                    <li>
                      <a href="#">
                        <img
                          src="assets/img/apps/app-store-1.png"
                          alt="app-img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="assets/img/apps/app-store-2.png"
                          alt="app-img"
                        />
                      </a>
                    </li>
          ...
          <div className="container">
            <div className="copyright1-inner">
              <div className="copyright-text copyright1-text">
                All Rights Reserved by Zonayed Ahamad
              </div>
